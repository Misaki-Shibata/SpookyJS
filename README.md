...
See the tests for an example of how to use SpookyJS with [Mocha](https://mochajs.org/). 
...
SpookyJS includes a suite of unit tests, driven by [Mocha](https://mochajs.org/). To run the tests:
...
* `TEST_REPORTER` the [Mocha reporter](https://mochajs.org/#reporters) to use (dot)
...
* `TEST_ARGS` Additional [arguments](https://mochajs.org/#usage) to pass through to Mocha
